...
/**
 * Clase heredada de FormasSM que contiene un objeto Ellipse2D_extended y
 * atributos propios
 *
 * @author Cesar Muñoz Reinoso
 */
public class Ellipse_Forma extends FormasSM {

    /**
     * Objeto Elipse
     */
    protected Ellipse2D_extended elipse;
    ...
    /**
     * Constructor que llama al constructor de Ellipse2D_extended
     *
     * @param x
     * @param y
     * @param w
     * @param h
     */
    public Ellipse_Forma(float x, float y, float w, float h) {
        super();
        elipse = new Ellipse2D_extended(x, y, w, h);
    }
