...
/**
 * Clase heredada de FormasSM que contiene un objeto Line2D_Extended y
 * atributos propios
 *
 * @author Cesar Muñoz Reinoso
 */
public class Line_Forma extends FormasSM{

    /**
     * Objeto Linea
     */
    protected Line2D_extended linea;
     ...
     * @param point0
     */
    public Line_Forma(Point2D point, Point2D point0) {
        super();
        linea = new Line2D_extended( point, point0);
    }
