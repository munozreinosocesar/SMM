...
/**
 * Clase heredada de FormasSM que contiene un objeto QuadCurve2D_extended y
 * atributos propios
 *
 * @author Cesar Muñoz Reinoso
 */
public class QuadCurve_Forma extends FormasSM {

    /**
     * Objeto Curva
     */
    protected QuadCurve2D_extended curva;
    ...
    /**
     * Constructor que llama al constructor de QuadCurve2D_extended
     *
     * @param x1
     * @param y1
     * @param ctrlx
     ...
     * @param y2
     */
    public QuadCurve_Forma(float x1, float y1, float ctrlx, float ctrly, float x2, float y2) {
        super();
        curva = new QuadCurve2D_extended(x1, y1, ctrlx, ctrly, x2, y2);

    }

    /**
     * Comprueba si el punto está cerca de la elipse creada
     *
     * @param pos
     * @return
     */
