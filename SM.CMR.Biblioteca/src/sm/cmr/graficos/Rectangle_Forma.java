...
/**
 * Clase heredada de FormasSM que contiene un objeto Rectangle2D_extended y
 * atributos propios
 *
 * @author Cesar Muñoz Reinoso
 */
public class Rectangle_Forma extends FormasSM {

    /**
     * Objeto Rectangle
     */
    protected Rectangle2D_extended rectangulo;
    ...
    /**
     * Constructor que llama al constructor de Rectangle2D_extended
     *
     * @param x
     * @param y
     * @param w
     * @param h
     */
    public Rectangle_Forma(float x, float y, float w, float h) {
        super();
        rectangulo = new Rectangle2D_extended(x, y, w, h);

    }

    /**
     * Comprueba si el punto está cerca del rectangulo creada
     *
     * @param pos
     * @return
     */
